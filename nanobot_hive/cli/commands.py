...
from nanobot_hive.cli.stream import StreamRenderer, ThinkingSpinner
from nanobot_hive.config.paths import get_workspace_path, is_default_workspace
from nanobot_hive.config.schema import Config
from nanobot_hive.utils.helpers import sync_workspace_templates
from nanobot_hive.utils.restart import (
...
def _init_prompt_session() -> None:
    ...
    from nanobot_hive.config.paths import get_cli_history_path
...
def onboard(
    ...
    from nanobot_hive.config.loader import get_config_path, load_config, save_config, set_config_path
    from nanobot_hive.config.schema import Config
    ...
    if wizard:
        from nanobot_hive.cli.onboard import run_onboard
...
def _onboard_plugins(config_path: Path) -> None:
    ...
    from nanobot_hive.channels.registry import discover_all
...
def _load_runtime_config(config: str | None = None, workspace: str | None = None) -> Config:
    ...
    from nanobot_hive.config.loader import load_config, resolve_config_env_vars, set_config_path
...
def _warn_deprecated_config_keys(config_path: Path | None) -> None:
    ...
    from nanobot_hive.config.loader import get_config_path
...
def _migrate_cron_store(config: "Config") -> None:
    ...
    from nanobot_hive.config.paths import get_cron_dir
...
def channels_status(
    ...
    """Show channel status."""
    from nanobot_hive.channels.registry import discover_all
    from nanobot_hive.config.loader import load_config, set_config_path
...
def _get_bridge_dir() -> Path:
    ...
    from nanobot_hive.config.paths import get_bridge_install_dir
...
def plugins_list():
    ...
    from nanobot_hive.channels.registry import discover_all, discover_channel_names
    from nanobot_hive.config.loader import load_config
...
def status():
    """Show nanobot status."""
    from nanobot_hive.config.loader import get_config_path, load_config
