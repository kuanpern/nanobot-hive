...
from nanobot_hive.agent.tools.schema import BooleanSchema, IntegerSchema, StringSchema, tool_parameters_schema
from nanobot_hive.utils.helpers import build_image_content_blocks, detect_image_mime
