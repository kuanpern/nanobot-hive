...
from nanobot_hive.agent.memory import Consolidator, Dream
from nanobot_hive.agent.runner import AgentRunSpec, AgentRunner
from nanobot_hive.agent.subagent import SubagentManager
from nanobot_hive.agent.tools.cron import CronTool
from nanobot_hive.agent.skills import BUILTIN_SKILLS_DIR
from nanobot_hive.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from nanobot_hive.agent.tools.message import MessageTool
from nanobot_hive.agent.tools.registry import ToolRegistry
from nanobot_hive.agent.tools.search import GlobTool, GrepTool
from nanobot_hive.agent.tools.shell import ExecTool
from nanobot_hive.agent.tools.spawn import SpawnTool
from nanobot_hive.agent.tools.web import WebFetchTool, WebSearchTool
from nanobot_hive.bus.events import InboundMessage, OutboundMessage
from nanobot_hive.command import CommandContext, CommandRouter, register_builtin_commands
from nanobot_hive.bus.queue import MessageBus
from nanobot_hive.config.schema import AgentDefaults
from nanobot_hive.providers.base import LLMProvider
from nanobot_hive.session.manager import Session, SessionManager
from nanobot_hive.utils.helpers import image_placeholder_text, truncate_text
from nanobot_hive.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE

if TYPE_CHECKING:
    from nanobot_hive.config.schema import ChannelsConfig, ExecToolConfig, WebToolsConfig
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from nanobot_hive.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        from nanobot_hive.config.schema import ExecToolConfig, WebToolsConfig
    ...
    async def _connect_mcp(self) -> None:
        ...
        from nanobot_hive.agent.tools.mcp import connect_mcp_servers
        try:
    ...
    def _tool_hint(tool_calls: list) -> str:
        ...
        from nanobot_hive.utils.tool_hints import format_tool_hints
