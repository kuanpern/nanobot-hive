...
from nanobot_hive.core.memory import Consolidator, Dream
from nanobot_hive.core.runner import AgentRunSpec, AgentRunner
from nanobot_hive.core.subagent import SubagentManager
from nanobot_hive.core.tools.cron import CronTool
from nanobot_hive.core.skills import BUILTIN_SKILLS_DIR
from nanobot_hive.core.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from nanobot_hive.core.tools.message import MessageTool
from nanobot_hive.core.tools.registry import ToolRegistry
from nanobot_hive.core.tools.search import GlobTool, GrepTool
from nanobot_hive.core.tools.shell import ExecTool
from nanobot_hive.core.tools.spawn import SpawnTool
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from nanobot_hive.core.tools.mcp import connect_mcp_servers
        try:
